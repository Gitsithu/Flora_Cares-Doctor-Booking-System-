...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form id="confirm_create_" action="/backend/specialization/{{ isset($obj)? $obj->id:0 }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    ...
                                    <p>
                                        ...
                                        <div class="form-line">
                                            <input type="text" value="{{ isset($obj)? $obj->name:Request::old(' name') }}" name="name" class="form-control date" placeholder="Specialization Type">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
