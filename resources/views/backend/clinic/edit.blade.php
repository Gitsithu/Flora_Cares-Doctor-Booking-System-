...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form id="confirm_create_" action="/backend/clinic/{{ isset($obj)? $obj->id:0 }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <p>
                                        ...
                                        <div class="form-line">
                                            <input type="text" value="{{ isset($obj)? $obj->name:Request::old(' name') }}" name="name" class="form-control date" placeholder="Clinic Name">
                                        </div>
                                    </div>
                                    </div>
                                <div class="col-md-6">
                             ...
                             <div class="row clearfix">
                               <div class="col-md-12">
                                ...
                                <div class="form-group">
                                     <textarea  class="form-control" name="address" value="" id="tinymice">{{ isset($obj)? $obj->address:Request::old('address') }}</textarea>
                                </div>
                                </div>
                                </div>
